...
If you haven't seen a Traefik configuration before it looks complicated, but it's not bad once the main points are explained. If you are used to Traefik syntax, skip the next paragraph. 
